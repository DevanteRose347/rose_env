...
class Customer(db.Model):
    ...
    carord  = db.relationship('CarOrder', backref = 'customer', lazy = True) #backref is just how are these related, lazy means a Customer can exist without the CarOrder table
